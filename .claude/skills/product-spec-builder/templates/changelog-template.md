...
遵循语义化版本（SemVer）:
- **Major (X.0.0)**: 新增核心功能域 / 删除已有功能 / 技术栈变更 / 破坏性 UI 架构改动
- **Minor (0.X.0)**: 新增辅助功能 / 现有功能显著增强 / 新增设计帧或页面
- **Patch (0.0.X)**: 修正措辞 / 补充验收标准 / 补全非功能需求 / 术语统一

版本号在 Product-Spec.md 顶部显式声明。每次变更后更新 CHANGELOG 并标注版本号变化。
